...
const Register = () => {
  ...
  return (
    <div className="min-h-[100dvh] relative flex items-center justify-center bg-muted/5 dark:bg-slate-950/10 p-4 py-8 overflow-y-auto scrollbar-hidden">
      ...
      <motion.div
        ...
        className="w-full max-w-[26rem] z-10"
      >

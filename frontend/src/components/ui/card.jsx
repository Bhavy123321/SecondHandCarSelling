...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-border/50 bg-card/70 dark:bg-slate-900/60 backdrop-blur-md text-card-foreground shadow-sm hover:shadow-lg transition-all duration-300",
      className,
    )}
    {...props}
  />
